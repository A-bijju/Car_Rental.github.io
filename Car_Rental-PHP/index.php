        ...
        <section class="menu-content">
            ...
            if(mysqli_num_rows($result1) > 0) {
                while($row1 = mysqli_fetch_assoc($result1)){
					...
					$car_capacity=$row1["car_capacity"];
			...
			<h6> <?php echo $car_nameplate; ?></h6>
			<h6>SEATING CAPACITY: <?php echo $car_capacity; ?></h6>
            <h6>  Fare: <?php echo ("Rs. " . $ac_price . "/km & Rs." . $ac_price_per_day . "/day"); ?></h6>
